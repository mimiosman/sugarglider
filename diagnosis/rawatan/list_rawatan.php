      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="diagnosis">
          ...
          <ul class="sidenav-second-level collapse" id="collapsediagnosis">
            <li>
              <a href="../simptom/list_simptom.html">Simptom</a>
            </li>
            <li>
              <a href="../penyakit/list_penyakit.html">Penyakit</a>
            </li>
            <li class="active">
              <a href="list_rawatan.html">Cara Rawatan</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="User">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Rawatan</li>
      </ol>
