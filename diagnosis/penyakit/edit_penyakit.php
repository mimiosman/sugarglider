...
if(isset($_POST['update']))
{
  ...
  if(empty($name) || empty($detail)) {
    ...
    //updating the table
    $result = mysqli_query($mysqli, "UPDATE `penyakit` SET `name`='$name',`detail`='$detail' WHERE id=$id")
          ...
          <div class="card-body">
            <form  name="add_penyakit" method="post" action="edit_penyakit.php">
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="name" name="name" placeholder="Nama Penyakit" value="<?php echo $name;?>">
                </div>
              </div>
              <div class="form-group row">
