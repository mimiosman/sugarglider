    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="User">
          <a class="nav-link" href="../pengguna/list_pengguna.html">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="diagnosis">
          ...
          <ul class="sidenav-second-level collapse" id="collapsediagnosis">
            <li>
              <a href="../diagnosis/simptom/list_simptom.html">Simptom</a>
            </li>
            <li>
              <a href="../diagnosis/penyakit/list_penyakit.html">Penyakit</a>
            </li>
            <li>
              <a href="../diagnosis/rawatan/list_rawatan.html">Cara Rawatan</a>
            </li>
          </ul>
        </li>
        <li class="nav-item active" data-toggle="tooltip" data-placement="right" title="User">
          <a class="nav-link" href="list_pakar.html">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="User">
          <a class="nav-link" href="../laporan/list_laporan.html">
