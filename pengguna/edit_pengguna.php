          ...
          <div class="card-body">
            <form>
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="nama" placeholder="Nama" value="Mimi Rosnida">
                </div>
              </div>
              <div class="form-group row">
                <label for="nric" class="col-sm-2 col-form-label">No Kad Pengenalan</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="nric" placeholder="No Kad Pengenalan" value="940210-11-5747">
                </div>
              </div>
              <div class="form-group row">
                <label for="email" class="col-sm-2 col-form-label">Emel</label>
                <div class="col-sm-4">
                  <input type="email" class="form-control" id="nric" placeholder="email" value="mimiiosman@fsktm.uthm.edu.my">
                </div>
              </div>
              <button type="submit" class="btn btn-primary">Kemaskini</button>
              <button type="submit" class="btn btn-danger">Batal</button></center>
            </form>
          </div>
